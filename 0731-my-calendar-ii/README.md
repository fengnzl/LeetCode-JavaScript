<h2><a href="https://leetcode.cn/problems/my-calendar-ii/">我的日程安排表 II</a></h2><h3>Medium</h3><hr><p>实现一个 <code>MyCalendar</code> 类来存放你的日程安排。如果要添加的时间内不会导致三重预订时，则可以存储这个新的日程安排。</p>
