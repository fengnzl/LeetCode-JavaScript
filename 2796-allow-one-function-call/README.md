<h2><a href="https://leetcode.cn/problems/allow-one-function-call/">只允许一次函数调用</a></h2><h3>Easy</h3><hr><p>给定一个函数 <code>fn</code> ，它返回一个新的函数，返回的函数与原始函数完全相同，只不过它确保 <code>fn</code> 最多被调用一次。</p>
