<h2><a href="https://leetcode.cn/problems/apply-transform-over-each-element-in-array/">转换数组中的每个元素</a></h2><h3>Easy</h3><hr><p>编写一个函数，这个函数接收一个整数数组&nbsp;<code>arr</code> 和一个映射函数&nbsp; <code>fn</code>&nbsp;，通过该映射函数返回一个新的数组。</p>
