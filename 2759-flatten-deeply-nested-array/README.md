<h2><a href="https://leetcode.cn/problems/flatten-deeply-nested-array/">扁平化嵌套数组</a></h2><h3>Medium</h3><hr><p>请你编写一个函数，它接收一个&nbsp;<strong>多维数组&nbsp;</strong><code>arr</code> 和它的深度 <code>n</code> ，并返回该数组的&nbsp;<strong>扁平化&nbsp;</strong>后的结果。</p>
