<h2><a href="https://leetcode.cn/problems/nested-array-generator/">嵌套数组生成器</a></h2><h3>Medium</h3><hr><p>现给定一个整数的 <strong>多维数组</strong> ，请你返回一个生成器对象，按照&nbsp;<strong>中序遍历</strong> 的顺序逐个生成整数。</p>
