<h2><a href="https://leetcode.cn/problems/minimum-deletions-to-make-string-balanced/">使字符串平衡的最少删除次数</a></h2><h3>Medium</h3><hr><p>给你一个字符串&nbsp;<code>s</code>&nbsp;，它仅包含字符&nbsp;<code>'a'</code> 和&nbsp;<code>'b'</code>​​​​ 。</p>
