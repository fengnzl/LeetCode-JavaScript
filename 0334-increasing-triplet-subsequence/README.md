<h2><a href="https://leetcode.cn/problems/increasing-triplet-subsequence/">递增的三元子序列</a></h2><h3>Medium</h3><hr><p>给你一个整数数组&nbsp;<code>nums</code> ，判断这个数组中是否存在长度为 <code>3</code> 的递增子序列。</p>
