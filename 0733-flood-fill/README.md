<h2><a href="https://leetcode.cn/problems/flood-fill/">图像渲染</a></h2><h3>Easy</h3><hr><p>有一幅以&nbsp;<code>m x n</code>&nbsp;的二维整数数组表示的图画&nbsp;<code>image</code>&nbsp;，其中&nbsp;<code>image[i][j]</code>&nbsp;表示该图画的像素值大小。</p>
